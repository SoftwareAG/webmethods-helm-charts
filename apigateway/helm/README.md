...
API Gateway Helm Chart for Kubernetes

## Requirements

| Repository | Name | Version |
|------------|------|---------|
| https://open-source.softwareag.com/webmethods-helm-charts/charts | common | 1.x.x |
| https://prometheus-community.github.io/helm-charts | prometheus-elasticsearch-exporter | 5.0.0 |
