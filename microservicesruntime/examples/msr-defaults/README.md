...
settings.watt.net.localhost="{{ include \"microservicesruntime.fullname\" . }}"
settings.watt.server.scheduler.logical.hostname=="{{ include \"microservicesruntime.fullname\" . }}"
